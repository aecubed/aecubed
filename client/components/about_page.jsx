    ...
    <div id='about-container'>
       ...
       <section id='more-info'>
         <div className='more-info-container'>More Information
           <p className='paragraph3'>Eu augue ut lectus arcu bibendum. Ipsum a arcu cursus vitae congue. Eu scelerisque felis imperdiet proin fermentum. Phasellus faucibus scelerisque eleifend donec pretium vulputate. Gravida in fermentum et sollicitudin ac orci phasellus egestas. Auctor urna nunc id cursus metus. Viverra justo nec ultrices dui. Nibh venenatis cras sed felis eget velit. Duis tristique sollicitudin nibh sit amet commodo nulla facilisi. Duis at tellus at urna condimentum. Sed felis eget velit aliquet sagittis id consectetur. Lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit. Nibh venenatis cras sed felis. Pellentesque habitant morbi tristique senectus et. Ut diam quam nulla porttitor. Mauris sit amet massa vitae tortor. Arcu odio ut sem nulla pharetra diam sit amet nisl.</p>
         </div>
       </section>
    </div>
  )
